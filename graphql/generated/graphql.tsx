...
export type MyQueryQuery = {
  ...
  allMinions?: {
    __typename?: 'MinionsConnection'
    nodes: Array<{ __typename?: 'Minion'; id: any; userName: string } | null>
  } | null
}
...
export const MyQueryDocument = `
  ...
  allMinions {
    ...
    `
export const useMyQueryQuery = <TData = MyQueryQuery, TError = unknown>(
  client: GraphQLClient,
  ...
  useQuery<MyQueryQuery, TError, TData>(
    ...
    fetcher<MyQueryQuery, MyQueryQueryVariables>(
      client,
      MyQueryDocument,
      variables,
      headers
